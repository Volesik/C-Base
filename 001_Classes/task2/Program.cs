...
namespace task2
{
    class Rectangle
    {
         ...
         * Это задание чисто на понимание как использовать различные конструкции классов, так
         * как гораздо проще и оптимальнее было бы написать прямо в геттерах действия
         */
